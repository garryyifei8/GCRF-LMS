...
public class BookCreateRequest {
    ...
    public Book toEntity() {
        ...
        book.setStatus(this.status != null ? this.status : "ACTIVE");
        // Note: createdAt and updatedAt will be auto-filled by MyBatis-Plus MetaObjectHandler
        // Note: availableQuantity will be set by service layer
        return book;
    }
}
